...
const filter = ({label, count, checked, disabled}) => {
...
const renderElement = (parent, element, quantity = getRandomInt(3, 7), data = []) => {
...
renderElement(mainFilter, filter, filters.length, filters);
renderElement(boardTasks, card, 7);

const filterElement = document.querySelectorAll(`.filter input`);
